    ...
    <div className="flex flex-col w-64 bg-gray-900 text-white">
      ...
      <nav className="flex-1 px-2 py-4 space-y-2">
        ...
        <Link
          ...
          className={getLinkClass('/admin/subscription-plans')}
        >
          <svg
            className="w-6 h-6"
            fill="none"
        ...
        >
          ...
          >
            <path
              ...
              strokeLinejoin="round"
              strokeWidth="2"
              d="M8 7V3m8 4V3m-9 8h10M5 21h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2zm0 0h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v12a2 2 0 002 2z"
            ></path>
          </svg>
